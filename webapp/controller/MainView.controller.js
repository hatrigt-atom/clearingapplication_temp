...
sap.ui.define([
     ...
     * @param {sap.ui.core.ValueState} ValueState Value state for input validation.
    ...
    function (BaseController,
        ...
        formatter,
        util,
        ValueState, Constants, MessageBox) {
        "use strict";
        ...
        return BaseController.extend("atom.ui.clearing.clearingapplication.controller.MainView", {
            ...
            onInit: function () {
                ...
                this._appModulePath = sap.ui.require.toUrl(Constants.appModulePath);
